package my.novelreader.scraper.databases
...
import my.novelreader.core.Response.Success
import my.novelreader.core.runCatchingAsResponse
...
import my.novelreader.network.tryFlatConnect
...
class NovelUpdates(
    ...
    override suspend fun getSearchFilters() = withContext(Dispatchers.Default) {
        tryFlatConnect {
            networkClient
                ...
                .map { (genre, id) ->
                    my.novelreader.scraper.SearchGenre(
                        id = id,
                        genreName = genre
                    )
                }
    ...
    private fun parseBookData(
        ...
        val genres = doc
            ...
            .map { my.novelreader.scraper.SearchGenre(genreName = it.text(), id = it.attr("gid")) }
