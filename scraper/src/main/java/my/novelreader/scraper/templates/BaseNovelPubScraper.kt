package my.novelreader.scraper.templates
...
abstract class BaseNovelPubScraper(
    ...
    override suspend fun getCatalogSearch(
        index: Int,
        input: String
    ): Response<my.novelreader.core.PagedList<my.novelreader.scraper.domain.BookResult>> {
        // Default: search not supported for NovelPub-style sites
        // Subclasses can override if their site supports search
        return Response.Success(my.novelreader.core.PagedList.createEmpty(index = index))
    }
